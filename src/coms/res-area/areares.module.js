...
(function() {
	...
	angular.module('webApp.coms.areares')
		...
		.controller("AreaResController", ['$scope', '$stateParams', '$state', '$location','Res', 'AreaRes','Prepare','$localStorage','ModalMsg','$timeout',
			function($scope, $stateParams, $state, $location,Res,AreaRes,Prepare,$localStorage,ModalMsg,$timeout) {
				// 筛选 主controller 
				// 变量共享
				$scope.VM = {};
				// 无数据 时显示
