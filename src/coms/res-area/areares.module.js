...
(function() {
	...
	angular.module('webApp.coms.areares')
		...
		.controller("AreaResController", ['$scope', '$stateParams', '$state', '$location', 'AreaRes','Prepare','$localStorage','ModalMsg',
			function($scope, $stateParams, $state, $location,AreaRes,Prepare,$localStorage,ModalMsg) {
				// 筛选 主controller 
				// 变量共享
				$scope.VM = {};
				// 关闭版本筛选
